            ...
            <div class="row">
                <div class="form-group" style="width: 100%;">
                    <div class="input-group">
                        <input type="text" class="form-control" id="name-file-mp3" readonly>
                        <div class="input-group-btn">
                            <span class="fileUpload btn btn-success">
                                ...
                                <input type="hidden" id="old-mp3" name="old_mp3" value="{{ $baihatmoi->file }}">
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="file-upload">
                        ...
                        <div class="image-upload-wrap">
                            ...
                            <input type="hidden" name="old_image" id="name-old-image" value="{{ asset('images/images_baihatmoi/'.$baihatmoi->image) }}">
                            <div class="drag-text">
                            <h3>Drag and drop a file or select add Image</h3>
                            </div>
                        </div>
                        <div class="file-upload-content">
                            <img class="file-upload-image" src="" id="old-image" alt="your image" />
...
<script>
    ...
    $(function aaa(){
         var inputVal = $('#name-old-image').val();
         $('.image-upload-wrap').hide();
         $('.file-upload-content').find('img#old-image').attr("src",inputVal);
