                    ...
                    @if (Auth::user()->id == $value->iduser)
                        <thead>
                            <tr>
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('delete_Baihatmoi',$value->id) }}">Xóa</a>
                                                <a class="dropdown-item" href="{{ route('getedit.baihat',$value->id) }}">sửa</a>
                                ...
                                <th>
                                    @if ($value->status == '1')
                                        <span class="badge badge-warning" ><h5>Chưa duyệt</h5></span>
                                    @elseif($value->status == '2')
                                        <span class="badge badge-warning"><h5>Không duyệt</h5></span>
                                    @elseif($value->status == '3')
                                        <span class="badge badge-success"><h5>Đã duyệt</h5></span>
                                    @endif
                                </th>
                            </tr>
                        </thead>
